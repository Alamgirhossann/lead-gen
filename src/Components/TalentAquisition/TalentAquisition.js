...
import aquisitionImg from "../../images/talent acqisition.png";
import aquisition1 from "../../images/aquisition (1).png";
import aquisition2 from "../../images/aquisition (2).png";
import aquisition3 from "../../images/aquisition (3).png";
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 d-flex align-items-center order-2 order-md-1">
              <div>
                <h3 className="langind-page-head">For Talent Acquisition</h3>
                <p className="font-sixteen">
                  Now you can directly target the best talent across industries
                  and find the right people who fit the bill.
                </p>
