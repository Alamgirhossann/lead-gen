...
import muchmoreImg from "../../images/Group 2879.png";
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 d-flex align-items-center order-2 order-md-1">
              <div>
                <h3 className="langind-page-head">For So Much More</h3>
                <p className="font-sixteen">
                  Leadzen offers you a host of additional services that help you
